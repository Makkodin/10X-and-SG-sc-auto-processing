...
refs_dir        =   '/mnt/raid0/ofateev/refs'
soft_dir        =   '/mnt/raid0/ofateev/soft'
type_load_data  =   'fastq'

MULTIOME_TYPES  =   {
                        'SC_TENX_Multiome_RNA': 'SC_TENX_Multiome_ATAC',
                        'SC_TENX_Multiome_ATAC': 'SC_TENX_Multiome_RNA',
                        'SC_SeekGene_Multiome_RNA': 'SC_SeekGene_Multiome_ATAC',
                        'SC_SeekGene_Multiome_ATAC': 'SC_SeekGene_Multiome_RNA'
                    }
