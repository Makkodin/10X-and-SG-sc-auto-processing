...
class ResultsType(Enum):
    ...
    SC_TENX_Multiome    = ["SC_TENX_Multiome_RNA",  "SC_TENX_Multiome_ATAC"]
    SC_SeekGene_Multiome= ["SC_SeekGene_Multiome_RNA","SC_SeekGene_Multiome_ATAC"]
    ...
    def _get_params(self):
        ...
        path_to_results = {
                ...
                'SC_TENX_Multiome'    :     {"fastq"    :   "1.Data/FASTQ",
                                            "local"     :   "2.Results/SG/Multiome",
                                            "ceph"      :   f"{CEPH}/SG_SC_RES/scMultiome",
                                            "postfix"   :   "outs/web_summary.html",
                                            "stat"      :   "outs/summary.csv"
                                            },
                'SC_SeekGene_Multiome':     {"fastq"    :   "1.Data/FASTQ",
                                            "local"     :   "2.Results/SG/Multiome",
                                            "ceph"      :   f"{CEPH}/SG_SC_RES/scMultiome",
                                            "postfix"   :   "_report.html",
                                            "stat"      :   "_summary.csv"
